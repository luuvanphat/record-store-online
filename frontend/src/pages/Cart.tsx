    ...
    <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-20 w-full flex-grow">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
        <div className="w-full lg:w-2/3">
          {cartItems.map((item) => (
            <div key={item.id} className="flex gap-6 py-6 border-b border-rs-border group">
              <Link to={`/product/${item.id}`} className="w-24 md:w-32 aspect-square bg-rs-gray flex-shrink-0">
              ...
              <div className="flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-sans mt-2 uppercase tracking-wider">Format: {item.category}</p>
                </div>

                <div className="flex justify-between items-end mt-4">
                  <div className="flex items-center border border-rs-border rounded-sm">
                    <button 
        ...
        <div className="w-full lg:w-1/3">
          <div className="bg-rs-gray p-8 sticky top-28">
            <h2 className="text-xl font-bold uppercase font-display text-rs-black mb-6 pb-4 border-b border-gray-300 tracking-wide">
              Tổng đơn hàng
            </h2>
            ...
            <div className="flex justify-between text-gray-600 font-sans mb-6 pb-6 border-b border-gray-300 text-sm">
              <span>Giao hàng</span>
            ...
            <button className="w-full bg-rs-black text-white py-4 uppercase tracking-widest text-xs font-bold hover:bg-gray-800 transition-colors font-sans">
              Thanh toán an toàn
            </button>
          </div>
        </div>
